<%-- 
    Document   : verify
    Created on : 15 Jul, 2012, 4:44:09 PM
    Author     : ARINDAM
--%>
            ...
            <div id="page">
                <div id="content">
                    ...
                    <div class="post">
                        ...
                        <p>
                        <form action="DoVerification" method="get">
                            <table>
                                <tr><td>ENTER THE APPLICATION I.D.</td><td><input type="text" name="applicationId" size="30"  ></td></tr>
                                <tr><td>VERIFYING STATUS(0/1/2)</td><td><input type="text" name="verified" size="30"  ></td></tr>
                                <tr><td>Click Here To Submit</td><td>
                                        <input type="submit" name="register" value="SUBMIT" ></td></tr>
                            </table>
