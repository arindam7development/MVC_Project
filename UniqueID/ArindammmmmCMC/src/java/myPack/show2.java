...
PrintWriter out=response.getWriter();
    ...
    //out.println("hello2");
    String query = "select * from user"; //where Application_I.D.='"+appId+"'" ;
   ResultSet rs=stmt.executeQuery(query);
   //out.println("hello");
    out.println("<html>");
     out.println("<body>");
   out.println("<table border='1'BGCOLOR='#FFFF00'align='center'>");
   while(rs.next())
   {
       out.println("<tr ><td>NAME</td><td><td><input type='text' value="+rs.getString(1)+"></td></tr>");
       out.println("<tr><td>APPLICATION I.D.</td><td><td><input type='text' value="+rs.getString(2)+"></td></tr>");
