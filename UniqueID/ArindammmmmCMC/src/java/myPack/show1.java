...
PrintWriter out=response.getWriter();
    ...
    //out.println("hello2");
    String query = "select * from registered"; //where Application_I.D.='"+appId+"'" ;
   ...
   while(rs.next())
   {
       out.println("<tr><td>ApplicationI.D.</td><td><td><input type='text' value="+rs.getString(1)+"></td></tr>");
       out.println("<tr><td>Unique I.D.</td><td><td><input type='text' value="+rs.getString(2)+"></td></tr>");
