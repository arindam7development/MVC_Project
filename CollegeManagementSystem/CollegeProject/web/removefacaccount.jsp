...
<s:query var="rs" sql="select *from facultyrecord"/>
<table width="300" align="center" bgcolor="lightgray" border="1" align="left">
    ...
    <tr bgcolor="white">
        ...
        <td>
           <a href="DeleteFacAccount.do?dello=${data.Faculty_ID}">Delete</a></td>
     </tr>
    </c:if>
    <c:if test="${s.count%2 != 0}">
    <tr>
        ...
        <td>${data.Designation}</td>
        <td>
            <a href="DeleteFacAccount.do?dello=${data.Faculty_ID}">Delete</a>
        </td>
     </tr>
    </c:if>
    </c:forEach>
