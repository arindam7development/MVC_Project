	...
	<div id="banner"><img src="css/images/pics01.jpg" width="1000" height="361" alt="" /></div>
        <div id="column2">
            <table align="center" bgcolor="lightgray">
                <tr><td><h1>ISSUE BOOKS </h1></td></tr>
                        </table>
                        <%@taglib uri="/WEB-INF/struts-html.tld" prefix="h"%>
                        <h:form action="BookIssue">
                     <table align ="center">
                     <tr><td class="test1">USER_ID&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h:text size="20" property="userid" /><br>
                     <tr><td class="test1">BOOK_ID&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h:text size="20" property="bookid"/><br>
                     <tr><td class="test1">DATE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h:text size="20" property="dat" value="dd/mm/yyyy"/><br>
                     <tr><td class="test1" bgcolor="cyan"><i>${requestScope.msg}</i></td></tr>
                     <tr><td class="test1"><h:submit property="submit" value="issue" /></td></tr>
                     </table>
